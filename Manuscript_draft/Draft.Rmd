...
The process-based model (constant $E_a$ over time) had, again as expected, a predictive power in between the two (but closer to the random forest model.)
