...
## Sites microclimate
<!-- ![Climatic parameters measured at the sites, plotted as data density of all measurements. Please notice thot not every time series covers the same period of time.](../Figures/climatedata.png){width=60%} -->
...
![Fit of the parametric model](../Figures/fit_model_validation.png){width=60%}


## Parametric model posteriors 

![Posteriors of the parameters varying as a function of treatments](../Figures/posteriors_boxplots.png){width=60%}

![Posteriors of the scaling parameter, varying as a function of single plots](../Figures/posteriors_boxplots_A.png){width=60%}
...
![Fit of the detailed random forest model (a) and variable importance of the same model (b)](../Figures/variance_decomposition.png){width=50%}
...
![Posteriors of the parameters of the temperature function, plotted as density distributions](../Figures/posteriors_temp.png)


![Posteriors of the parameters of the moisture function, plotted as density distributions](../Figures/posteriors_seasonality.png)


![Posteriors of the parameters of the seasonality function, plotted as density distributions](../Figures/posteriors_moisture.png)
...
![Temperature scaling function](../Figures/Temp.png){width=50%}


![Moisture scaling function](../Figures/Moist.png){width=50%}



![Seasonality scaling function](../Figures/Season.png){width=50%}
