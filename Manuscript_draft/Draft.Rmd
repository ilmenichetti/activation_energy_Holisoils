...
$$
Rh(t) =  \xi_{temp(t,j)} \cdot \xi_{moist(t,j)} \right) + \xi_{sin(t,j)}
$$
...
## Sites microclimate
![Climatic parameters measured at the sites, plotted as data density of all measurements](../Figures/climatedata.png)



## Benchmark models and parametric model fit

![Alt text](../Figures/fit_ML_validation.png)



![Alt text](../Figures/fit_model_validation.png)


## Parametric model posteriors 

![Alt text](../Figures/posteriors_boxplots.png)

![Alt text](../Figures/posteriors_boxplots_A.png)



## Machine learning variance decomposition

![Alt text](../Figures/variance_decomposition.png)
...
![Alt text](../Figures/scenario_extrapolation.png)
