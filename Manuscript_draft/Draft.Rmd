---
title: "The impact of forest management on the temperature sensitivity of organic matter"
author: "Leticia Perez-Izquiero, Lorenzo Menichetti, Jorge Curiel-Juste, etc"
date: "2024-07-04"
output:
...
Soil temperature and moisture resulted the most important variables in predicting respiration from each site by far, followed by edaphic charachrteristics of the site (density and porosity), then by treatment, and then again by edaphic site characteristics (namely pH and total C). Only afterwards the first variable related to aboveground vegetation. Variables related to biomass, total and specific to microorganisms classes, come only later and did not seem particularly important.  
