...
## Machine learning variance decomposition: predicting the whole dataset based on ecological variables
...
## Machine learning variance decomposition: predicting a substet based on soil enzymatic data

![Fit of the detailed random forest model (a) and variable importance of the same model (b)](../Figures/variance_decomposition_enzyme.png){width=50%}
