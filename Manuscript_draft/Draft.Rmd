...
![Fit of the two benchmark machine learning models, linear (a) and random forest (b)](../Figures/Appendix/enzymes_boxplots.png){width=80%}
...
# Display the table with HTML superscripts
kable(anova_results, escape = FALSE)
```
