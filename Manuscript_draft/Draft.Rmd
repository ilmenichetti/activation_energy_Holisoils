...
The scaling parameter $A$ was still needed to explain some of the variance in respiration measured at the level of single experimental plots even after normalization by SOC stocks. This is likely because of the high variability in SOC content of soils

## Role of temperature and moisture in decomposition 
The process-based model showed that processes related to soil temperature and moisture were able to explained more than 50% of variance in soil respiration. MORE REFS RELATED TO MODELS (Nissan et al 2023,etc.). 
...
### Relationships between organic matter charachteristics, inputs of C to the soil, and temperature sensitivity
